...
_EXPECTED_IO_WATCH = frozenset({
    ...
    "tempfile.TemporaryDirectory", "tempfile.mkstemp", "tempfile.mkdtemp", "tempfile.mktemp",
    "mmap.mmap",
    ...
    "print", "input", "sys.stdout.write", "sys.stderr.write", "sys.stdin.read",
...
def _probe_declared_roles():
    ...
    if set(EXEMPT_FROM_DECLARATION) != {"tree-sitter-honest-hd", "tree-sitter-honest-jinja",
                                       "honest-boot", "honest-dom", "honest-components", "honest-format"}:
