...
EXEMPT_FROM_DECLARATION = {
    ...
    "honest-page": "declaration owed, not waived: its reference implementation is python/app.py and the templates, and extract_tokens belongs in a .hd. Tracked as honest-framework-3h1; remove this entry when the declaration lands",
}
